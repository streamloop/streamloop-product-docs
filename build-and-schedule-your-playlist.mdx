...
<Steps>
  ...
  <Step title="Add videos">
    Click **Upload** to add MP4, MOV, or MKV files from your computer. The limit is 1.5 GB per
    file for free users and 5 GB per file for paid users; split larger videos into playlist
    chunks. You can also choose **From URL** to import from Google Drive, a YouTube link, or a
    direct download link, or drag files straight onto the list.
  </Step>
