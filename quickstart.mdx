...
description: "Go from a video file to a 24/7 live stream in minutes — upload HDR or SDR video, choose quality up to 4K 60fps, connect a destination, and go live."
keywords:
...
<Steps>
  ...
  <Step title="Pick your quality">
    ...
    (24, 25, 30, or 60fps). Streamloop also supports HDR video. Your destination and playback
    devices must support HDR for viewers to see it. Higher quality costs more per hour —
    `1080p` at `30fps` suits most streams. See the price breakdown in [Billing](/billing).
  </Step>
  <Step title="Connect a destination">
    ...
    Twitch, or any other RTMP platform.
  </Step>
  <Step title="Go live">
